...
class GastoPersonalizadoRegMovimientoPage extends StatefulWidget {


  final int idCard;

  GastoPersonalizadoRegMovimientoPage({
    super.key,
    required this.idCard,
  });
  @override
  State<GastoPersonalizadoRegMovimientoPage> createState() => _GastoPersonalizadoRegMovimientoPageState();
}

class _GastoPersonalizadoRegMovimientoPageState extends State<GastoPersonalizadoRegMovimientoPage> {
  // estado
  ...
  Future<void> _cargarCategorias(int idCard,String tipo) async {
    final res = await service.obtenerCategoriaPersonalizadoxTipo(context,idCard ,tipo);
                                  ...
                                  children: [
                                    _SegmentChip(
                                      ...
                                      onTap: () {
                                        ...
                                        _cargarCategorias(widget.idCard,'GASTO');
                                      },
                                    ),
                                    ...
                                    _SegmentChip(
                                      ...
                                      onTap: () {
                                        ...
                                        _cargarCategorias(widget.idCard,'INGRESO');
                                      },
                                    ),
                                  ],
                                ),
